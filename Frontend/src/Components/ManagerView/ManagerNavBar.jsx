...
const navItems = [
    ...
    { text: 'Assets', icon: <AssetsIcon />, path: '/manager/asset' },
    { text: 'Request', icon: <RequestIcon />, path: '/manager/request' },
    { text: 'Allocation', icon: <AllocationIcon />, path: '/manager/allocation' },
    { text: 'Return', icon: <ReturnIcon />, path: '/manager/return' },
];
