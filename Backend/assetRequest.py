...
def serialize_asset_request(doc):
    ...
    if doc:
        ...
        return {
            ...
            "RequestStatus": doc.get('Request_Status', 'Pending')
...
def get_request_status_enum(status_str):
...
def put_asset_request(asset_req_id):
    ...
    try:
        ...
        current_status = existing_request.get("Request_Status", "Pending")
        ...
        update_data = {"Request_Status": new_status}
...
def delete_asset_request(asset_req_id):
    ...
    try:
        ...
        if request_doc.get("Request_Status") == "Allocated":
...
def get_asset_requests_by_status():
    ...
    try:
        ...
        requests = list(asset_requests.find({"Request_Status": status}))
